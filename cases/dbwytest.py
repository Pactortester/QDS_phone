...
class Nanny(MyTestCase):
    ...
    def test_dbwy(self):
        ...
        self.driver.find_element_by_xpath("//android.widget.TextView[@resource-id=\"com.dream.ipm:id/cb_product_detail_option\" and @text=\"担保无忧注册\"]").click()
        ...
        self.assertEqual(total_price, str(5280.0), "金额异常请检查!")
